...
// Dynamic icons with props - these change appearance based on props
export interface ArrowIconProps extends BaseIconProps {
  direction?: "left" | "up" | "right" | "down";
}

export const ArrowIcon = ({ direction = "down", ...props }: ArrowIconProps) => {
  const {
    width,
    height,
    className,
  ...
  const arrowPaths = {
    down: (
      <path
        d="M12.0004 9H9.00038V1C9.00038 0.734784 8.89502 0.48043 8.70748 0.292893C8.51995 0.105357 8.26559 0 8.00038 0C7.73516 0 7.48081 0.105357 7.29327 0.292893C7.10573 0.48043 7.00038 0.734784 7.00038 1V9H4.00038C3.81194 8.99993 3.62733 9.0531 3.4678 9.15338C3.30827 9.25367 3.18032 9.39698 3.09869 9.56682C3.01707 9.73665 2.98509 9.92609 3.00644 10.1133C3.02779 10.3005 3.10161 10.4779 3.21938 10.625L7.21938 15.625C7.31306 15.7422 7.4319 15.8367 7.56709 15.9017C7.70229 15.9667 7.85037 16.0005 8.00038 16.0005C8.15038 16.0005 8.29847 15.9667 8.43366 15.9017C8.56885 15.8367 8.68769 15.7422 8.78138 15.625L12.7814 10.625C12.8991 10.4779 12.973 10.3005 12.9943 10.1133C13.0157 9.92609 12.9837 9.73665 12.9021 9.56682C12.8204 9.39698 12.6925 9.25367 12.533 9.15338C12.3734 9.0531 12.1888 8.99993 12.0004 9Z"
        fill={color}
      />
    ),
    up: (
    ...
    right: (
      <path
        d="M10.625 3.21889C10.4779 3.10112 10.3005 3.0273 10.1133 3.00595C9.92609 2.9846 9.73665 3.01658 9.56682 3.09821C9.39698 3.17983 9.25367 3.30778 9.15338 3.46731C9.0531 3.62684 8.99993 3.81146 9 3.99989V6.99989H1C0.734784 6.99989 0.48043 7.10524 0.292893 7.29278C0.105357 7.48032 0 7.73467 0 7.99989C0 8.2651 0.105357 8.51946 0.292893 8.70699C0.48043 8.89453 0.734784 8.99989 1 8.99989H9V11.9999C8.99993 12.1883 9.0531 12.3729 9.15338 12.5325C9.25367 12.692 9.39698 12.8199 9.56682 12.9016C9.73665 12.9832 9.92609 13.0152 10.1133 12.9938C10.3005 12.9725 10.4779 12.8987 10.625 12.7809L15.625 8.78089C15.7422 8.6872 15.8367 8.56837 15.9017 8.43317C15.9667 8.29798 16.0005 8.14989 16.0005 7.99989C16.0005 7.84988 15.9667 7.7018 15.9017 7.5666C15.8367 7.43141 15.7422 7.31257 15.625 7.21889L10.625 3.21889Z"
        fill={color}
      />
    ),
    left: (
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <g clipPath={`url(#clip0_arrow_${direction})`}>{arrowPaths[direction]}</g>
      <defs>
        <clipPath id={`clip0_arrow_${direction}`}>
          <rect width="16" height="16" fill="white" />
        </clipPath>
      </defs>
    </svg>
...
export interface ReplyIconProps extends BaseIconProps {
  filled?: boolean;
}

export const ReplyIcon = ({ filled = false, ...props }: ReplyIconProps) => {
  const {
    width,
    height,
    className,
  ...
  return (
    <svg
      ...
      className={className}
      style={style}
      aria-label={ariaLabel || `Reply ${filled ? "(filled)" : "(outline)"}`}
      aria-hidden={ariaHidden}
      {...rest}
    >
      <g clipPath={`url(#clip0_reply_${filled ? "filled" : "outline"})`}>
        {filled ? (
          <path
      ...
      <defs>
        <clipPath id={`clip0_reply_${filled ? "filled" : "outline"}`}>
          <rect width="16" height="16" fill="white" />
        </clipPath>
      </defs>
    </svg>
...
export interface HeartIconProps extends BaseIconProps {
  filled?: boolean;
}
...
export const HeartIcon = ({ filled = false, ...props }: HeartIconProps) => {
  ...
  return (
    <svg
      ...
      className={className}
      style={style}
      aria-label={ariaLabel || `Heart ${filled ? "(filled)" : "(outline)"}`}
      aria-hidden={ariaHidden}
      {...rest}
    >
      <g clipPath={`url(#clip0_heart_${filled ? "filled" : "outline"})`}>
        {filled ? (
          <path
      ...
      <defs>
        <clipPath id={`clip0_heart_${filled ? "filled" : "outline"}`}>
          <rect width="16" height="16" fill="white" />
        </clipPath>
      </defs>
    </svg>
